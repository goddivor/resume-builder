...
const Features = () => {
  ...
  return (
    ...
    <Title title={t('features.title')} description={t('features.description')}/>
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">{t('features.feature1Title')}</h3>
                                <p className="text-sm text-slate-600 max-w-xs">{t('features.feature1Description')}</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">{t('features.feature2Title')}</h3>
                                <p className="text-sm text-slate-600 max-w-xs">{t('features.feature2Description')}</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">{t('features.feature3Title')}</h3>
                                <p className="text-sm text-slate-600 max-w-xs">{t('features.feature3Description')}</p>
                            </div>
                        </div>
                    </div>
                </div>
